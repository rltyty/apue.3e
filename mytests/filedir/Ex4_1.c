...
[file]:/dev/stdin           [type]: character special [value]:  020000
/dev/stdin -> /proc/self/fd/0 [file]:/var/run/systemd/fs  [type]: socket
[value]: 0140000 [file]:tmp/data/filedir/fi  [type]:              fifo [value]:
010000
 */
