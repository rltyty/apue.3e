 ...
 * Option 2: allocate in thr_fn1()
 * In both options, the pointer to the struct foo object will passed to
 * pthread_exit() and 
 */
...
{
        if (arg == NULL) {
          my_perror("error: thr_fn1: NULL arg");
        }
        struct foo *fp = arg;
        fp->a = 1;
        fp->b = 2;
...
:!Debug/threads/Ex11_1_good_exit
thread 1:
  structure at 0x600000f60040
  foo.a = 1
  foo.b = 2
  foo.c = 3
  foo.d = 4
parent starting second thread
thread 2: ID is 123145570361344
parent:
  structure at 0x600000f60040
  foo.a = 1
  foo.b = 2
